...
func (r *Repository) CreateCategory(data *CategoryCreateDto) (CategoryModel, error) {
	var c CategoryModel
...
func (r *Repository) GetAllCategories() ([]CategoryModel, error) {
	var cList []CategoryModel

	redisKey := "products:categories"
	cachedCategories, err := cache.Get[[]CategoryModel](r.redis, redisKey)
...
func (r *Repository) DeleteCategory(id int) (CategoryModel, error) {
	var c CategoryModel
